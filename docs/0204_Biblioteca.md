...
- **SEO & Social Sharing**: A página individual de episódios (`/biblioteca/episodio/[id]`) possui metadados Open Graph (OG) otimizados com URLs absolutas forçadas para o domínio principal (`nossawebtv.com.br`), garantindo a exibição de miniaturas no WhatsApp e Facebook.
