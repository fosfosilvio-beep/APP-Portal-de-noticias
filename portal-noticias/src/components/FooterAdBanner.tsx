      ...
      <div className="container mx-auto">
        {imageUrl ? (
          <a
            ...
            className="group relative w-full block overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-700/40 hover:border-zinc-600"
            aria-label={altText}
          >
            <img
              src={imageUrl}
