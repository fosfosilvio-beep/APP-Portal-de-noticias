                ...
                <section className="border-t border-slate-100 pt-8 mt-8">
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-slate-700">{config?.email_contato || "contato@nossawebtv.com.br"}</span>
                    </div>
                    <a 
                      href={`mailto:${config?.email_contato || "contato@nossawebtv.com.br"}?subject=Solicitação de Exclusão de Dados`}
